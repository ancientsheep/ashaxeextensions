...
::neash::system::Capabilities_obj::__register();
...
::com::ancientsheep::particles::NSDictionary_obj::__register();
::com::ancientsheep::particles::CGAffineTransform_obj::__register();
::com::ancientsheep::particles::CCTypes_obj::__register();
::com::ancientsheep::particles::GL_obj::__register();
::com::ancientsheep::particles::ASSize_obj::__register();
::com::ancientsheep::particles::ASPointExtensions_obj::__register();
::com::ancientsheep::particles::ASParticleSystem_obj::__register();
::com::ancientsheep::particles::ASParticle_obj::__register();
::com::ancientsheep::particles::ASMacros_obj::__register();
::com::ancientsheep::particles::ASConfig_obj::__register();
::Xml_obj::__register();
...
::Type_obj::__boot();
::XmlType_obj::__boot();
::com::ancientsheep::particles::ASConfig_obj::__boot();
::com::ancientsheep::particles::ASMacros_obj::__boot();
::com::ancientsheep::particles::ASParticle_obj::__boot();
::com::ancientsheep::particles::ASParticleSystem_obj::__boot();
::com::ancientsheep::particles::ASPointExtensions_obj::__boot();
::com::ancientsheep::particles::ASSize_obj::__boot();
::com::ancientsheep::particles::GL_obj::__boot();
::com::ancientsheep::particles::CCTypes_obj::__boot();
::com::ancientsheep::particles::CGAffineTransform_obj::__boot();
::com::ancientsheep::particles::NSDictionary_obj::__boot();
...
::neash::system::Capabilities_obj::__boot();
