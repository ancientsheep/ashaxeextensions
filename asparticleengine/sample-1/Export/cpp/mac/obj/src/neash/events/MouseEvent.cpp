...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",50)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",51)
	this->localX = localX;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",52)
	this->localY = localY;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",53)
	this->relatedObject = relatedObject;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",54)
	this->ctrlKey = ctrlKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",55)
	this->altKey = altKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",56)
	this->shiftKey = shiftKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",57)
	this->buttonDown = buttonDown;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",58)
	this->delta = delta;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",59)
	this->commandKey = commandKey;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",60)
...
::neash::events::Event MouseEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",65)
...
::neash::events::MouseEvent MouseEvent_obj::nmeCreateSimilar( ::String inType,::neash::display::InteractiveObject related,::neash::display::InteractiveObject targ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",83)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",85)
	result->stageX = this->stageX;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",86)
	result->stageY = this->stageY;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",87)
	if (((targ != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",88)
		result->nmeSetTarget(targ);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",89)
	return result;
}
...
::String MouseEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",94)
...
::neash::events::MouseEvent MouseEvent_obj::nmeCreate( ::String inType,Dynamic inEvent,::neash::geom::Point inLocal,::neash::display::InteractiveObject inTarget){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",72)
	int flags = inEvent->__Field(HX_CSTRING("flags"),true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",73)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",74)
	evt->stageX = inEvent->__Field(HX_CSTRING("x"),true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",75)
	evt->stageY = inEvent->__Field(HX_CSTRING("y"),true);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",76)
	evt->nmeSetTarget(inTarget);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/MouseEvent.hx",77)
	return evt;
}
