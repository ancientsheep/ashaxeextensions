...
Void Lib_obj::close( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",49)
		Dynamic close = ::neash::Loader_obj::load(HX_CSTRING("nme_close"),(int)0);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",50)
		close();
	}
return null();
}
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",54)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",56)
		if ((::neash::Lib_obj::sIsInit)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",57)
			hx::Throw (HX_CSTRING("nme.Lib.create called multiple times. This function is automatically called by the project code."));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",60)
		::neash::Lib_obj::sIsInit = true;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",61)
		::neash::Lib_obj::initWidth = inWidth1->__get((int)0);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",62)
		::neash::Lib_obj::initHeight = inHeight1->__get((int)0);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",63)
...
{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",67)
				::neash::Lib_obj::nmeMainFrame = inFrameHandle;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",68)
				Dynamic stage_handle = ::neash::Lib_obj::nme_get_frame_stage(::neash::Lib_obj::nmeMainFrame);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",69)
				::neash::Lib_obj::nmeStage = ::neash::display::Stage_obj::__new(stage_handle,inWidth1->__get((int)0),inHeight1->__get((int)0));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",70)
				::neash::Lib_obj::nmeStage->nmeSetFrameRate(inFrameRate1->__get((int)0));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",71)
				::neash::Lib_obj::nmeStage->nmeSetBG(inColour1->__get((int)0));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",72)
				::neash::Lib_obj::nmeStage->onQuit = ::neash::Lib_obj::close_dyn();
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",73)
				if (((::neash::Lib_obj::nmeCurrent != null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",74)
					::neash::Lib_obj::nmeStage->addChild(::neash::Lib_obj::nmeCurrent);
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",75)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",64)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",84)
		::neash::Lib_obj::initWidth = inWidth;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",85)
		::neash::Lib_obj::initHeight = inHeight;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",86)
		::neash::display::ManagedStage result = ::neash::display::ManagedStage_obj::__new(inWidth,inHeight,inFlags);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",87)
		::neash::Lib_obj::nmeStage = result;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",88)
		return result;
	}
}
...
Void Lib_obj::exit( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",94)
		Dynamic quit = ::neash::Lib_obj::nmeGetStage()->onQuit_dyn();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",95)
		if (((quit != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",96)
			quit().Cast< Void >();
		}
	}
return null();
...
Void Lib_obj::forceClose( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",111)
		Dynamic terminate = ::neash::Loader_obj::load(HX_CSTRING("nme_terminate"),(int)0);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",112)
		terminate();
	}
return null();
}
...
int Lib_obj::getTimer( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",117)
...
Void Lib_obj::getURL( ::neash::net::URLRequest url,::String target){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",124)
...
Void Lib_obj::nmeSetCurrentStage( ::neash::display::Stage inStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",133)
...
Void Lib_obj::pause( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",139)
...
Void Lib_obj::postUICallback( Dynamic inCallback){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",145)
...
Void Lib_obj::resume( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",157)
...
Void Lib_obj::setIcon( ::String path){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",172)
		Dynamic set_icon = ::neash::Loader_obj::load(HX_CSTRING("nme_set_icon"),(int)1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",173)
		set_icon(path);
	}
return null();
}
...
Void Lib_obj::setPackage( ::String inCompany,::String inFile,::String inPack,::String inVersion){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",178)
		::neash::Lib_obj::company = inCompany;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",179)
		::neash::Lib_obj::file = inFile;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",180)
		::neash::Lib_obj::packageName = inPack;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",181)
		::neash::Lib_obj::version = inVersion;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",182)
...
::neash::display::MovieClip Lib_obj::nmeGetCurrent( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",190)
	if (((::neash::Lib_obj::nmeCurrent == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",192)
		::neash::Lib_obj::nmeCurrent = ::neash::display::MovieClip_obj::__new();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",193)
		if (((::neash::Lib_obj::nmeStage != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",194)
			::neash::Lib_obj::nmeStage->addChild(::neash::Lib_obj::nmeCurrent);
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",196)
...
::neash::display::Stage Lib_obj::nmeGetStage( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",202)
	if (((::neash::Lib_obj::nmeStage == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",203)
		hx::Throw (HX_CSTRING("Error : stage can't be accessed until init is called"));
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Lib.hx",204)
...
void Lib_obj::__boot()
{
	...
	hx::Static(nme_pause_animation) = ::neash::Loader_obj::load(HX_CSTRING("nme_pause_animation"),(int)0);
	hx::Static(nme_resume_animation) = ::neash::Loader_obj::load(HX_CSTRING("nme_resume_animation"),(int)0);
}
