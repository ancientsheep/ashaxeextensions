...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",173)
	this->mListner = inListener;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",174)
	this->mUseCapture = inUseCapture;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",175)
	this->mPriority = inPriority;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",176)
...
Void Listener_obj::dispatchEvent( ::neash::events::Event event){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",181)
		this->mListner(event);
	}
return null();
}
...
bool Listener_obj::Is( Dynamic inListener,bool inCapture){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",187)
