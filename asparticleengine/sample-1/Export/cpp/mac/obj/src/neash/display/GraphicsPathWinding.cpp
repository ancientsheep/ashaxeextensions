...
#ifndef INCLUDED_neash_display_GraphicsPathWinding
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.display.GraphicsPathWinding"), hx::TCanCast< GraphicsPathWinding_obj> ,sStaticFields,sMemberFields,
...
{
	hx::Static(EVEN_ODD) = HX_CSTRING("evenOdd");
	hx::Static(NON_ZERO) = HX_CSTRING("nonZero");
}
