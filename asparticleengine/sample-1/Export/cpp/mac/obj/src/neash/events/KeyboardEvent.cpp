...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",22)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",24)
	this->keyCode = keyCodeValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",25)
	this->keyLocation = keyLocationValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",26)
	this->charCode = charCodeValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",28)
	this->shiftKey = shiftKeyValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",29)
	this->altKey = altKeyValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",30)
	this->controlKey = controlKeyValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",31)
	this->commandKey = commandKeyValue;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",32)
...
::neash::events::Event KeyboardEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",37)
...
::String KeyboardEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/KeyboardEvent.hx",43)
