...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",27)
	this->a = (  (((in_a == null()))) ? Dynamic(1.0) : Dynamic(in_a) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",28)
	this->b = (  (((in_b == null()))) ? Dynamic(0.0) : Dynamic(in_b) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",29)
	this->c = (  (((in_c == null()))) ? Dynamic(0.0) : Dynamic(in_c) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",30)
	this->d = (  (((in_d == null()))) ? Dynamic(1.0) : Dynamic(in_d) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",31)
	this->tx = (  (((in_tx == null()))) ? Dynamic(0.0) : Dynamic(in_tx) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",32)
...
::neash::geom::Matrix Matrix_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",37)
...
Void Matrix_obj::concat( ::neash::geom::Matrix m){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",58)
		double a1 = ((this->a * m->a) + (this->b * m->c));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",59)
		this->b = ((this->a * m->b) + (this->b * m->d));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",60)
		this->a = a1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",62)
		double c1 = ((this->c * m->a) + (this->d * m->c));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",63)
		this->d = ((this->c * m->b) + (this->d * m->d));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",65)
		this->c = c1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",67)
		double tx1 = (((this->tx * m->a) + (this->ty * m->c)) + m->tx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",68)
		this->ty = (((this->tx * m->b) + (this->ty * m->d)) + m->ty);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",69)
		this->tx = tx1;
	}
return null();
}
...
Void Matrix_obj::createBox( double scaleX,double scaleY,Dynamic rotation,Dynamic tx,Dynamic ty){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",75)
		this->a = scaleX;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",76)
		this->d = scaleY;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",77)
		this->b = (  (((rotation == null()))) ? Dynamic(0.0) : Dynamic(rotation) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",78)
		this->tx = (  (((tx == null()))) ? Dynamic(0.0) : Dynamic(tx) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",79)
...
Void Matrix_obj::createGradientBox( double in_width,double in_height,Dynamic rotation,Dynamic in_tx,Dynamic in_ty){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",85)
		this->a = (double(in_width) / double(1638.4));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",86)
		this->d = (double(in_height) / double(1638.4));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",89)
		if (((bool((rotation != null())) && bool((rotation != 0.0))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",91)
			double cos = ::Math_obj::cos(rotation);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",92)
			double sin = ::Math_obj::sin(rotation);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",93)
			this->b = (sin * this->d);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",94)
			this->c = (-(sin) * this->a);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",95)
			hx::MultEq(this->a,cos);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",96)
			hx::MultEq(this->d,cos);
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",99)
			this->b = this->c = (int)0;
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",103)
		this->tx = (  (((in_tx != null()))) ? double((in_tx + (double(in_width) / double((int)2)))) : double((double(in_width) / double((int)2))) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",104)
...
::neash::geom::Point Matrix_obj::deltaTransformPoint( ::neash::geom::Point point){
	HX_SOURCE_PUSH("Matrix_obj::deltaTransformPoint")
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",109)
...
Void Matrix_obj::identity( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",116)
		this->a = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",117)
		this->b = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",118)
		this->c = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",119)
		this->d = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",120)
		this->tx = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",121)
		this->ty = (int)0;
	}
return null();
}
...
::neash::geom::Matrix Matrix_obj::invert( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",127)
	double norm = ((this->a * this->d) - (this->b * this->c));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",129)
	if (((norm == (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",131)
		this->a = this->b = this->c = this->d = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",132)
		this->tx = -(this->tx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",133)
		this->ty = -(this->ty);
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",137)
		norm = (double(1.0) / double(norm));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",138)
		double a1 = (this->d * norm);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",139)
		this->d = (this->a * norm);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",140)
		this->a = a1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",141)
		hx::MultEq(this->b,-(norm));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",142)
		hx::MultEq(this->c,-(norm));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",144)
		double tx1 = ((-(this->a) * this->tx) - (this->c * this->ty));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",145)
		this->ty = ((-(this->b) * this->tx) - (this->d * this->ty));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",146)
		this->tx = tx1;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",149)
...
::neash::geom::Matrix Matrix_obj::mult( ::neash::geom::Matrix m){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",155)
	::neash::geom::Matrix result = ::neash::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",157)
	result->a = ((this->a * m->a) + (this->b * m->c));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",158)
	result->b = ((this->a * m->b) + (this->b * m->d));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",159)
	result->c = ((this->c * m->a) + (this->d * m->c));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",160)
	result->d = ((this->c * m->b) + (this->d * m->d));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",162)
	result->tx = (((this->tx * m->a) + (this->ty * m->c)) + m->tx);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",163)
	result->ty = (((this->tx * m->b) + (this->ty * m->d)) + m->ty);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",165)
	return result;
}
...
Void Matrix_obj::rotate( double inTheta){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",183)
		double cos = ::Math_obj::cos(inTheta);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",184)
		double sin = ::Math_obj::sin(inTheta);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",186)
		double a1 = ((this->a * cos) - (this->b * sin));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",187)
		this->b = ((this->a * sin) + (this->b * cos));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",188)
		this->a = a1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",190)
		double c1 = ((this->c * cos) - (this->d * sin));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",191)
		this->d = ((this->c * sin) + (this->d * cos));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",192)
		this->c = c1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",194)
		double tx1 = ((this->tx * cos) - (this->ty * sin));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",195)
		this->ty = ((this->tx * sin) + (this->ty * cos));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",196)
		this->tx = tx1;
	}
return null();
}
...
Void Matrix_obj::scale( double inSX,double inSY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",209)
		hx::MultEq(this->a,inSX);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",210)
		hx::MultEq(this->b,inSY);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",212)
		hx::MultEq(this->c,inSX);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",213)
		hx::MultEq(this->d,inSY);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",215)
		hx::MultEq(this->tx,inSX);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",216)
...
Void Matrix_obj::setRotation( double inTheta,Dynamic inScale){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",222)
		double scale = (  (((inScale == null()))) ? Dynamic(1.0) : Dynamic(inScale) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",223)
		this->a = (::Math_obj::cos(inTheta) * scale);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",224)
		this->c = (::Math_obj::sin(inTheta) * scale);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",225)
		this->b = -(this->c);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",226)
		this->d = this->a;
	}
return null();
}
...
::neash::geom::Point Matrix_obj::transformPoint( ::neash::geom::Point inPos){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",231)
...
Void Matrix_obj::translate( double inDX,double inDY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",238)
		hx::AddEq(this->tx,inDX);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Matrix.hx",239)
...
double Matrix_obj::__INumField(int inFieldID)
{
	...
	if (inFieldID==__id_deltaTransformPoint) return hx::ToDouble( deltaTransformPoint_dyn() ) ;
