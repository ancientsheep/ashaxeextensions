...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",29)
	super::__construct(::neash::display::DisplayObject_obj::nme_create_display_object(),HX_CSTRING("Bitmap"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",31)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",32)
	this->nmeSetSmoothing(smoothing);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",34)
	if (((bitmapData != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",35)
		this->nmeSetBitmapData(bitmapData);
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",38)
		if (((this->bitmapData != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",39)
			this->nmeRebuild();
		}
	}
}
...
{
		HX_SOURCE_PUSH("Bitmap_obj::nmeRebuild")
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",46)
		if (((bool((this->nmeHandle != null())) && bool((this->bitmapData != null()))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",49)
			::neash::display::Graphics gfx = this->nmeGetGraphics();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",50)
			gfx->clear();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",52)
			if (((this->bitmapData != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",54)
				gfx->beginBitmapFill(this->bitmapData,null(),false,this->smoothing);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",55)
				gfx->drawRect((int)0,(int)0,this->bitmapData->nmeGetWidth(),this->bitmapData->nmeGetHeight());
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",56)
				gfx->endFill();
			}
		}
	}
...
::neash::display::BitmapData Bitmap_obj::nmeSetBitmapData( ::neash::display::BitmapData inBitmapData){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",69)
	this->bitmapData = inBitmapData;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",70)
	this->nmeRebuild();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",72)
	return inBitmapData;
}
...
bool Bitmap_obj::nmeSetSmoothing( bool inSmooth){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",78)
	this->smoothing = inSmooth;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",79)
	this->nmeRebuild();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Bitmap.hx",81)
	return inSmooth;
}
