...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/IOErrorEvent.hx",11)
...
::neash::events::Event IOErrorEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/IOErrorEvent.hx",17)
...
::String IOErrorEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/IOErrorEvent.hx",23)
