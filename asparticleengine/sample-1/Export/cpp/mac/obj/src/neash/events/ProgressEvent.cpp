...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/ProgressEvent.hx",16)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/ProgressEvent.hx",17)
	this->bytesLoaded = bytesLoaded;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/ProgressEvent.hx",18)
...
::neash::events::Event ProgressEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/ProgressEvent.hx",23)
...
::String ProgressEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/ProgressEvent.hx",29)
