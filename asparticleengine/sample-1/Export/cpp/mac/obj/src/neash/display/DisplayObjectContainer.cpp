...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",24)
	super::__construct(inHandle,inType);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",25)
...
::neash::display::DisplayObject DisplayObjectContainer_obj::addChild( ::neash::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",31)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",31)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",32)
	return child;
}
...
::neash::display::DisplayObject DisplayObjectContainer_obj::addChildAt( ::neash::display::DisplayObject child,int index){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",38)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",38)
		if (((child == hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",38)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",39)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",39)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",40)
	return child;
}
...
bool DisplayObjectContainer_obj::areInaccessibleObjectsUnderPoint( ::neash::geom::Point point){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",45)
	return false;
}
...
bool DisplayObjectContainer_obj::contains( ::neash::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",52)
	if (((child == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",53)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",55)
	if (((hx::ObjectPtr<OBJ_>(this) == child))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",56)
		return true;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",58)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",58)
		int _g = (int)0;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",58)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",59)
			if (((c == child))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",60)
				return true;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",62)
	return false;
}
...
::neash::display::DisplayObject DisplayObjectContainer_obj::getChildAt( int index){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",68)
	if (((bool((index >= (int)0)) && bool((index < this->nmeChildren->length))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",69)
		return this->nmeChildren->__get(index);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",72)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",74)
	return null();
}
...
::neash::display::DisplayObject DisplayObjectContainer_obj::getChildByName( ::String name){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",80)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",80)
		int _g = (int)0;
		Array< ::neash::display::DisplayObject > _g1 = this->nmeChildren;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",80)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",81)
			if (((name == c->nmeGetName()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",82)
				return c;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",83)
	return null();
}
...
int DisplayObjectContainer_obj::getChildIndex( ::neash::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",88)
...
Array< ::neash::display::DisplayObject > DisplayObjectContainer_obj::getObjectsUnderPoint( ::neash::geom::Point point){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",95)
	Array< ::neash::display::DisplayObject > result = Array_obj< ::neash::display::DisplayObject >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",96)
	this->nmeGetObjectsUnderPoint(point,result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",97)
	return result;
}
...
Void DisplayObjectContainer_obj::nmeAddChild( ::neash::display::DisplayObject child){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",103)
		if (((child == hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",104)
			hx::Throw (HX_CSTRING("Adding to self"));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",108)
		if (((child->nmeParent == hx::ObjectPtr<OBJ_>(this)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",109)
			this->setChildIndex(child,(this->nmeChildren->length - (int)1));
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",114)
			child->nmeSetParent(hx::ObjectPtr<OBJ_>(this));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",115)
			this->nmeChildren->push(child);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",116)
			::neash::display::DisplayObjectContainer_obj::nme_doc_add_child(this->nmeHandle,child->nmeHandle);
		}
	}
return null();
...
Void DisplayObjectContainer_obj::nmeBroadcast( ::neash::events::Event inEvt){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",123)
		int i = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",125)
		if (((this->nmeChildren->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",126)
			while((true)){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",128)
				::neash::display::DisplayObject child = this->nmeChildren->__get(i);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",129)
				child->nmeBroadcast(inEvt);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",131)
				if (((i >= this->nmeChildren->length))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",132)
					break;
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",134)
				if (((this->nmeChildren->__get(i) == child))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",136)
					(i)++;
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",137)
					if (((i >= this->nmeChildren->length))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",138)
						break;
					}
				}
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",142)
...
::neash::display::DisplayObject DisplayObjectContainer_obj::nmeFindByID( int inID){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",148)
	if (((this->nmeID == inID))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",149)
		return hx::ObjectPtr<OBJ_>(this);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",151)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",151)
		int _g = (int)0;
		Array< ::neash::display::DisplayObject > _g1 = this->nmeChildren;
		...
		while(((_g < _g1->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",151)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",153)
			::neash::display::DisplayObject found = child->nmeFindByID(inID);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",155)
			if (((found != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",156)
				return found;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",159)
...
int DisplayObjectContainer_obj::nmeGetChildIndex( ::neash::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",165)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",165)
		int _g1 = (int)0;
		int _g = this->nmeChildren->length;
		...
		while(((_g1 < _g))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",165)
			int i = (_g1)++;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",166)
			if (((this->nmeChildren->__get(i) == child))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",167)
				return i;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",168)
	return (int)-1;
}
...
Void DisplayObjectContainer_obj::nmeGetObjectsUnderPoint( ::neash::geom::Point point,Array< ::neash::display::DisplayObject > result){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",174)
		this->super::nmeGetObjectsUnderPoint(point,result);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",176)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",176)
			int _g = (int)0;
			Array< ::neash::display::DisplayObject > _g1 = this->nmeChildren;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",176)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",177)
...
Void DisplayObjectContainer_obj::nmeOnAdded( ::neash::display::DisplayObject inObj,bool inIsOnStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",183)
		this->super::nmeOnAdded(inObj,inIsOnStage);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",185)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",185)
			int _g = (int)0;
			Array< ::neash::display::DisplayObject > _g1 = this->nmeChildren;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",185)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",186)
...
Void DisplayObjectContainer_obj::nmeOnRemoved( ::neash::display::DisplayObject inObj,bool inWasOnStage){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",192)
		this->super::nmeOnRemoved(inObj,inWasOnStage);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",194)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",194)
			int _g = (int)0;
			Array< ::neash::display::DisplayObject > _g1 = this->nmeChildren;
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",194)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",195)
...
Void DisplayObjectContainer_obj::nmeRemoveChildFromArray( ::neash::display::DisplayObject child){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",201)
		int i = this->nmeGetChildIndex(child);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",203)
		if (((i >= (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",205)
			::neash::display::DisplayObjectContainer_obj::nme_doc_remove_child(this->nmeHandle,i);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",206)
...
Void DisplayObjectContainer_obj::nmeSetChildIndex( ::neash::display::DisplayObject child,int index){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",213)
		if (((index > this->nmeChildren->length))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",214)
			hx::Throw ((HX_CSTRING("Invalid index position ") + index));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",216)
		::neash::display::DisplayObject s = null();
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",217)
		int orig = this->nmeGetChildIndex(child);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",219)
		if (((orig < (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",221)
			::String msg = ((HX_CSTRING("setChildIndex : object ") + child->toString()) + HX_CSTRING(" not found."));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",223)
			if (((child->nmeParent == hx::ObjectPtr<OBJ_>(this)))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",225)
				int realindex = (int)-1;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",227)
				{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",227)
					int _g1 = (int)0;
					int _g = this->nmeChildren->length;
					...
					while(((_g1 < _g))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",227)
						int i = (_g1)++;
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",229)
						if (((this->nmeChildren->__get(i) == child))){
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",231)
							realindex = i;
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",232)
							break;
						}
					}
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",236)
				if (((realindex != (int)-1))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",237)
					hx::AddEq(msg,(HX_CSTRING("Internal error: Real child index was ") + ::Std_obj::string(realindex)));
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",239)
					hx::AddEq(msg,HX_CSTRING("Internal error: Child was not in nmeChildren array!"));
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",242)
			hx::Throw (msg);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",245)
		::neash::display::DisplayObjectContainer_obj::nme_doc_set_child_index(this->nmeHandle,child->nmeHandle,index);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",247)
		if (((index < orig))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",249)
			int i = orig;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",251)
			while(((i > index))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",253)
				this->nmeChildren[i] = this->nmeChildren->__get((i - (int)1));
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",254)
				(i)--;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",257)
			this->nmeChildren[index] = child;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",260)
			if (((orig < index))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",262)
				int i = orig;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",263)
				while(((i < index))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",265)
					this->nmeChildren[i] = this->nmeChildren->__get((i + (int)1));
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",266)
					(i)++;
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",269)
				this->nmeChildren[index] = child;
			}
		}
	}
...
Void DisplayObjectContainer_obj::nmeSwapChildrenAt( int index1,int index2){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",276)
		if (((bool((bool((bool((index1 < (int)0)) || bool((index2 < (int)0)))) || bool((index1 > this->nmeChildren->length)))) || bool((index2 > this->nmeChildren->length))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",277)
			hx::Throw (::neash::errors::RangeError_obj::__new(HX_CSTRING("swapChildrenAt : index out of bounds")));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",279)
		if (((index1 != index2))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",281)
			::neash::display::DisplayObject tmp = this->nmeChildren->__get(index1);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",282)
			this->nmeChildren[index1] = this->nmeChildren->__get(index2);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",283)
			this->nmeChildren[index2] = tmp;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",284)
...
::neash::display::DisplayObject DisplayObjectContainer_obj::removeChild( ::neash::display::DisplayObject child){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",291)
	int c = this->nmeGetChildIndex(child);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",293)
	if (((c >= (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",295)
		child->nmeSetParent(null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",296)
		return child;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",301)
	return null();
}
...
::neash::display::DisplayObject DisplayObjectContainer_obj::removeChildAt( int index){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",307)
	if (((bool((index >= (int)0)) && bool((index < this->nmeChildren->length))))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",309)
		::neash::display::DisplayObject result = this->nmeChildren->__get(index);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",310)
		result->nmeSetParent(null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",311)
		return result;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",314)
...
Void DisplayObjectContainer_obj::setChildIndex( ::neash::display::DisplayObject child,int index){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",319)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",320)
			if (((index > this->nmeChildren->length))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",320)
				hx::Throw ((HX_CSTRING("Invalid index position ") + index));
			}
...
Void DisplayObjectContainer_obj::swapChildren( ::neash::display::DisplayObject child1,::neash::display::DisplayObject child2){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",326)
		int idx1 = this->nmeGetChildIndex(child1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",327)
		int idx2 = this->nmeGetChildIndex(child2);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",328)
		if (((bool((idx1 < (int)0)) || bool((idx2 < (int)0))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",329)
			hx::Throw (HX_CSTRING("swapChildren:Could not find children"));
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",330)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",330)
...
Void DisplayObjectContainer_obj::swapChildrenAt( int index1,int index2){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",335)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",336)
			if (((bool((bool((bool((index1 < (int)0)) || bool((index2 < (int)0)))) || bool((index1 > this->nmeChildren->length)))) || bool((index2 > this->nmeChildren->length))))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",336)
				hx::Throw (::neash::errors::RangeError_obj::__new(HX_CSTRING("swapChildrenAt : index out of bounds")));
			}
...
bool DisplayObjectContainer_obj::nmeGetMouseChildren( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",345)
...
bool DisplayObjectContainer_obj::nmeSetMouseChildren( bool inVal){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",348)
	::neash::display::DisplayObjectContainer_obj::nme_doc_set_mouse_children(this->nmeHandle,inVal);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",349)
	return inVal;
}
...
int DisplayObjectContainer_obj::nmeGetNumChildren( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",353)
...
bool DisplayObjectContainer_obj::nmeGetTabChildren( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",354)
	return false;
}
...
bool DisplayObjectContainer_obj::nmeSetTabChildren( bool inValue){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/DisplayObjectContainer.hx",355)
	return false;
}
