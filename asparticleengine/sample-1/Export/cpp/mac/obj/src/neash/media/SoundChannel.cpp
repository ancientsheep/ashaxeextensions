...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",29)
	super::__construct(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",31)
	if (((sndTransform != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",31)
		this->nmeTransform = sndTransform->clone();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",35)
	if (((inSoundHandle != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",36)
		this->nmeHandle = ::neash::media::SoundChannel_obj::nme_sound_channel_create(inSoundHandle,startTime,loops,this->nmeTransform);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",38)
	if (((this->nmeHandle != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",39)
...
bool SoundChannel_obj::nmeCheckComplete( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",57)
	if (((this->nmeHandle != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",59)
		if (((bool((this->nmeDataProvider != null())) && bool(::neash::media::SoundChannel_obj::nme_sound_channel_needs_data(this->nmeHandle))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",61)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",62)
			request->position = ::neash::media::SoundChannel_obj::nme_sound_channel_get_data_position(this->nmeHandle);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",63)
			this->nmeDataProvider->dispatchEvent(request);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",64)
			if (((request->data->length > (int)0))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",65)
				::neash::media::SoundChannel_obj::nme_sound_channel_add_data(this->nmeHandle,request->data);
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",68)
		if ((::neash::media::SoundChannel_obj::nme_sound_channel_is_complete(this->nmeHandle))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",70)
			this->nmeHandle = null();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",71)
			if (((this->nmeDataProvider != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",72)
				(::neash::media::SoundChannel_obj::nmeDynamicSoundCount)--;
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",73)
			::neash::events::Event complete = ::neash::events::Event_obj::__new(::neash::events::Event_obj::SOUND_COMPLETE,null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",74)
			this->dispatchEvent(complete);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",75)
			return true;
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",79)
	return false;
}
...
Void SoundChannel_obj::stop( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",109)
...
double SoundChannel_obj::nmeGetLeft( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",119)
...
double SoundChannel_obj::nmeGetRight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",120)
...
double SoundChannel_obj::nmeGetPosition( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",121)
...
::neash::media::SoundTransform SoundChannel_obj::nmeGetTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",126)
	if (((this->nmeTransform == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",127)
		this->nmeTransform = ::neash::media::SoundTransform_obj::__new(null(),null());
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",131)
...
::neash::media::SoundTransform SoundChannel_obj::nmeSetTransform( ::neash::media::SoundTransform inTransform){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",137)
	this->nmeTransform = inTransform->clone();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",138)
	::neash::media::SoundChannel_obj::nme_sound_channel_set_transform(this->nmeHandle,this->nmeTransform);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",140)
	return inTransform;
}
...
::neash::media::SoundChannel SoundChannel_obj::createDynamic( Dynamic inSoundHandle,::neash::media::SoundTransform sndTransform,::neash::events::EventDispatcher dataProvider){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",44)
	::neash::media::SoundChannel result = ::neash::media::SoundChannel_obj::__new(null(),(int)0,(int)0,sndTransform);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",45)
	result->nmeDataProvider = dataProvider;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",46)
	result->nmeHandle = inSoundHandle;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",47)
	::neash::media::SoundChannel_obj::nmeIncompleteList->push(result);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",48)
	(::neash::media::SoundChannel_obj::nmeDynamicSoundCount)++;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",49)
	return result;
}
...
bool SoundChannel_obj::nmeCompletePending( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",84)
...
Void SoundChannel_obj::nmePollComplete( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",90)
		if (((::neash::media::SoundChannel_obj::nmeIncompleteList->length > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",93)
			Array< ::neash::media::SoundChannel > incomplete = Array_obj< ::neash::media::SoundChannel >::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",95)
			{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",95)
				int _g = (int)0;
				...
				while(((_g < _g1->length))){
					...
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",95)
					++(_g);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",97)
					if ((!(channel->nmeCheckComplete()))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",98)
						incomplete->push(channel);
					}
				}
			}
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundChannel.hx",103)
