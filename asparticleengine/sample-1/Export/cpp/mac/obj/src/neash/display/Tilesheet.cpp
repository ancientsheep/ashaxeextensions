...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Tilesheet.hx",28)
	this->nmeBitmap = inImage;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Tilesheet.hx",29)
...
Void Tilesheet_obj::addTileRect( ::neash::geom::Rectangle rectangle,::neash::geom::Point centerPoint){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Tilesheet.hx",34)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Tilesheet.hx",59)
