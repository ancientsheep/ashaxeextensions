...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/errors/Error.hx",13)
	this->message = inMessage;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/errors/Error.hx",14)
	this->errorID = id;
}
;
	return null();
...
::String Error_obj::getStackTrace( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/errors/Error.hx",19)
	return HX_CSTRING("");
}
...
::String Error_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/errors/Error.hx",25)
	return this->message;
}
