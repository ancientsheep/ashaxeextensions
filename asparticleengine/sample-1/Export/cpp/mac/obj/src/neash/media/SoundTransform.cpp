...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundTransform.hx",13)
	this->volume = vol;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundTransform.hx",14)
	this->pan = panning;
}
;
	return null();
...
::neash::media::SoundTransform SoundTransform_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/media/SoundTransform.hx",19)
