...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequestHeader.hx",9)
	this->name = name;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequestHeader.hx",10)
	this->value = value;
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.net.URLRequestHeader"), hx::TCanCast< URLRequestHeader_obj> ,sStaticFields,sMemberFields,
