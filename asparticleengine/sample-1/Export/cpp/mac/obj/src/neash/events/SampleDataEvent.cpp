...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/SampleDataEvent.hx",18)
	super::__construct(type,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/SampleDataEvent.hx",19)
	this->data = ::neash::utils::ByteArray_obj::__new(null());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/SampleDataEvent.hx",20)
	this->data->bigEndian = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/SampleDataEvent.hx",21)
	this->position = 0.0;
}
;
	return null();
...
::neash::events::Event SampleDataEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/SampleDataEvent.hx",26)
...
::String SampleDataEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/SampleDataEvent.hx",32)
