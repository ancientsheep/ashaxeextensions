...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/HTTPStatusEvent.hx",13)
	super::__construct(inType,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/HTTPStatusEvent.hx",14)
	this->status = status;
}
;
	return null();
...
::neash::events::Event HTTPStatusEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/HTTPStatusEvent.hx",19)
...
::String HTTPStatusEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/HTTPStatusEvent.hx",25)
