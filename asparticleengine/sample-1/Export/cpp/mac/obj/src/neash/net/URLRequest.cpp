...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",32)
	if (((inURL != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",33)
		this->url = inURL;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",34)
	this->requestHeaders = Array_obj< ::neash::net::URLRequestHeader >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",35)
	this->method = HX_CSTRING("GET");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",37)
	this->verbose = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",38)
	this->cookieString = HX_CSTRING("");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",39)
	this->authType = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",40)
	this->contentType = HX_CSTRING("application/x-www-form-urlencoded");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",41)
...
Void URLRequest_obj::basicAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",45)
		this->authType = (int)1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",46)
...
Void URLRequest_obj::digestAuth( ::String inUser,::String inPasswd){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",50)
		this->authType = (int)2;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",51)
		this->credentials = ((inUser + HX_CSTRING(":")) + inPasswd);
	}
return null();
}
...
Void URLRequest_obj::nmePrepare( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",54)
		if (((bool(::Std_obj::is(this->data,hx::ClassOf< ::neash::utils::ByteArray >())) || bool((this->data == null()))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",55)
			this->nmeBytes = this->data;
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",57)
			if ((::Std_obj::is(this->data,hx::ClassOf< ::neash::net::URLVariables >()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",58)
				::neash::net::URLVariables vars = this->data;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",59)
				::String str = vars->toString();
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",60)
				this->nmeBytes = ::neash::utils::ByteArray_obj::__new(null());
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",61)
				this->nmeBytes->writeUTFBytes(str);
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",62)
				if ((::Std_obj::is(this->data,hx::ClassOf< ::String >()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",63)
					::String str = this->data;
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",64)
					this->nmeBytes = ::neash::utils::ByteArray_obj::__new(null());
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",65)
					this->nmeBytes->writeUTFBytes(str);
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",66)
					if ((::Std_obj::is(this->data,hx::ClassOf< ::Dynamic >()))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",67)
						::neash::net::URLVariables vars = ::neash::net::URLVariables_obj::__new(null());
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",68)
						{
							HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",68)
							int _g = (int)0;
							...
							while(((_g < _g1->length))){
								...
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",68)
								++(_g);
								HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",69)
								if (((vars != null()))){
									HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",69)
						...
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",70)
						::String str = vars->toString();
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",71)
						this->nmeBytes = ::neash::utils::ByteArray_obj::__new(null());
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",72)
						this->nmeBytes->writeUTFBytes(str);
					}
					else{
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLRequest.hx",73)
