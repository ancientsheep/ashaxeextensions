...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/FocusEvent.hx",22)
	super::__construct(inType,bubbles,cancelable);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/FocusEvent.hx",23)
	this->relatedObject = relatedObject;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/FocusEvent.hx",24)
	this->keyCode = keyCode;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/FocusEvent.hx",25)
...
::neash::events::Event FocusEvent_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/FocusEvent.hx",30)
...
::String FocusEvent_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/FocusEvent.hx",36)
