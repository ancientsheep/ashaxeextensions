...
::String Loader_obj::findHaxeLib( ::String inLib){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",32)
	try{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",34)
		::sys::io::Process proc = ::sys::io::Process_obj::__new(HX_CSTRING("haxelib"),Array_obj< ::String >::__new().Add(HX_CSTRING("path")).Add(inLib));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",35)
		if (((proc != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",37)
			::haxe::io::Input stream = proc->_stdout;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",38)
			try{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",39)
				while((true)){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",42)
					::String s = stream->readLine();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",43)
					if (((s.substr((int)0,(int)1) != HX_CSTRING("-")))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",45)
						stream->close();
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",46)
						proc->close();
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",47)
						::neash::Loader_obj::loaderTrace((HX_CSTRING("Found haxelib ") + s));
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",48)
						return s;
					}
				}
			}
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",53)
			stream->close();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",54)
			proc->close();
		}
	}
	catch(Dynamic __e){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",59)
	return HX_CSTRING("");
}
...
Dynamic Loader_obj::load( ::String func,int args){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",65)
	if ((::neash::Loader_obj::moduleInit)){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",66)
		return ::cpp::Lib_obj::load(::neash::Loader_obj::moduleName,func,args);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",74)
	::neash::Loader_obj::moduleInit = true;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",75)
	::neash::Loader_obj::moduleName = HX_CSTRING("nme");
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",78)
	Dynamic result = ::neash::Loader_obj::tryLoad(HX_CSTRING("./nme"),func,args);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",79)
	if (((result == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",80)
		result = ::neash::Loader_obj::tryLoad(HX_CSTRING(".\\nme"),func,args);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",83)
	if (((result == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",84)
		result = ::neash::Loader_obj::tryLoad(HX_CSTRING("nme"),func,args);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",86)
	if (((result == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",88)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",89)
		::String haxelib = ::neash::Loader_obj::findHaxeLib(HX_CSTRING("nme"));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",90)
		if (((haxelib != HX_CSTRING("")))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",92)
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",95)
			if (((result == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",96)
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",100)
	::neash::Loader_obj::loaderTrace((HX_CSTRING("Result : ") + result));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",106)
	return result;
}
...
Void Loader_obj::loaderTrace( ::String inStr){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",129)
		Dynamic get_env = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("get_env"),(int)1);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",130)
		bool debug = (get_env(HX_CSTRING("NME_LOAD_DEBUG")) != null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",135)
		if ((debug)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",136)
...
Dynamic Loader_obj::sysName( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",144)
	Dynamic sys_string = ::cpp::Lib_obj::load(HX_CSTRING("std"),HX_CSTRING("sys_string"),(int)0);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",145)
	return sys_string();
}
...
Dynamic Loader_obj::tryLoad( ::String inName,::String func,int args){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",154)
	try{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",156)
		Dynamic result = ::cpp::Lib_obj::load(inName,func,args);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",157)
		if (((result != null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",159)
			::neash::Loader_obj::loaderTrace((HX_CSTRING("Got result ") + inName));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",160)
			::neash::Loader_obj::moduleName = inName;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",161)
			return result;
		}
	}
	catch(Dynamic __e){
		{
			Dynamic e = __e;{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",165)
				::neash::Loader_obj::loaderTrace((HX_CSTRING("Failed to load : ") + inName));
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/Loader.hx",168)
	return null();
}
