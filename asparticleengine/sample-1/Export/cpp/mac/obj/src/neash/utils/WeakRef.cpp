...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",16)
	if ((inMakeWeak)){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",19)
		this->weakRef = ::neash::utils::WeakRef_obj::nme_weak_ref_create(hx::ObjectPtr<OBJ_>(this),inObject);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",20)
		this->hardRef = null();
	}
	else{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",24)
		this->weakRef = (int)-1;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",25)
...
Dynamic WeakRef_obj::get( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",32)
	if (((this->hardRef != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",33)
		return this->hardRef;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",35)
	if (((this->weakRef < (int)0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",36)
		return null();
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",38)
	Dynamic result = ::neash::utils::WeakRef_obj::nme_weak_ref_get(this->weakRef);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",39)
	if (((result == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",40)
		this->weakRef = (int)-1;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",41)
	return result;
}
...
::String WeakRef_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",47)
	if (((this->hardRef == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",48)
		return (HX_CSTRING("") + this->hardRef);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/utils/WeakRef.hx",50)
