...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",18)
	this->nmeTarget = (  (((target == null()))) ? ::neash::events::IEventDispatcher(hx::ObjectPtr<OBJ_>(this)) : ::neash::events::IEventDispatcher(target) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",19)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",25)
		if (((this->nmeEventMap == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",26)
			this->nmeEventMap = ::Hash_obj::__new();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",27)
		Array< ::neash::utils::WeakRef > list = this->nmeEventMap->get(type);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",28)
		if (((list == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",30)
			list = Array_obj< ::neash::utils::WeakRef >::__new();
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",31)
			this->nmeEventMap->set(type,list);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",34)
		::neash::events::Listener l = ::neash::events::Listener_obj::__new(listener,useCapture,priority);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",35)
...
Void EventDispatcher_obj::DispatchCompleteEvent( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",45)
		::neash::events::Event evt = ::neash::events::Event_obj::__new(::neash::events::Event_obj::COMPLETE,null(),null());
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",46)
...
bool EventDispatcher_obj::dispatchEvent( ::neash::events::Event event){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",52)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",53)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",54)
	if (((event->nmeGetTarget() == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",55)
		event->nmeSetTarget(this->nmeTarget);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",57)
	if (((event->nmeGetCurrentTarget() == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",58)
		event->nmeSetCurrentTarget(this->nmeTarget);
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",60)
	Array< ::neash::utils::WeakRef > list = this->nmeEventMap->get(event->nmeGetType());
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",61)
	bool capture = (event->nmeGetEventPhase() == ::neash::events::EventPhase_obj::CAPTURING_PHASE);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",63)
	if (((list != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",65)
		int idx = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",66)
		while(((idx < list->length))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",68)
			::neash::utils::WeakRef list_item = list->__get(idx);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",69)
			::neash::events::Listener listener = (  (((list_item != null()))) ? ::neash::events::Listener(list_item->get()) : ::neash::events::Listener(null()) );
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",71)
			if (((listener == null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",72)
				list->splice(idx,(int)1);
			}
			else{
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",78)
				if (((listener->mUseCapture == capture))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",80)
					listener->dispatchEvent(event);
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",81)
					if ((event->nmeGetIsCancelledNow())){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",82)
						return true;
					}
				}
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",84)
				(idx)++;
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",88)
		return true;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",91)
	return false;
}
...
Void EventDispatcher_obj::DispatchIOErrorEvent( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",101)
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",102)
		this->dispatchEvent(evt);
	}
return null();
}
...
bool EventDispatcher_obj::hasEventListener( ::String type){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",108)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",109)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",110)
	Array< ::neash::utils::WeakRef > h = this->nmeEventMap->get(type);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",111)
	if (((h != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",112)
		int _g = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",112)
		while(((_g < h->length))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",112)
			::neash::utils::WeakRef item = h->__get(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",112)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",113)
			if (((item != null()))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",113)
				return true;
			}
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",116)
	return false;
}
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",122)
		if (((this->nmeEventMap == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",123)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",125)
		if ((!(this->nmeEventMap->exists(type)))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",125)
			return null();
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",127)
		Array< ::neash::utils::WeakRef > list = this->nmeEventMap->get(type);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",128)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",128)
			int _g1 = (int)0;
			int _g = list->length;
			...
			while(((_g1 < _g))){
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",128)
				int i = (_g1)++;
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",130)
				if (((list->__get(i) != null()))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",132)
					::neash::events::Listener li = list->__get(i)->get();
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",133)
					if ((li->Is(listener,capture))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",136)
						list[i] = null();
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",137)
						return null();
					}
				}
			}
...
::String EventDispatcher_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",145)
...
bool EventDispatcher_obj::willTrigger( ::String type){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",152)
	if (((this->nmeEventMap == null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",153)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/EventDispatcher.hx",154)
