...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",45)
	this->x = (  (((inX == null()))) ? Dynamic((int)0) : Dynamic(inX) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",46)
	this->y = (  (((inY == null()))) ? Dynamic((int)0) : Dynamic(inY) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",47)
	this->width = (  (((inWidth == null()))) ? Dynamic((int)0) : Dynamic(inWidth) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",48)
...
::neash::geom::Rectangle Rectangle_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",53)
...
bool Rectangle_obj::contains( double inX,double inY){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",59)
...
bool Rectangle_obj::containsPoint( ::neash::geom::Point point){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",65)
...
bool Rectangle_obj::containsRect( ::neash::geom::Rectangle rect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",71)
...
bool Rectangle_obj::equals( ::neash::geom::Rectangle toCompare){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",77)
...
Void Rectangle_obj::extendBounds( ::neash::geom::Rectangle r){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",84)
		double dx = (this->x - r->x);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",85)
		if (((dx > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",87)
			hx::SubEq(this->x,dx);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",88)
			hx::AddEq(this->width,dx);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",90)
		double dy = (this->y - r->y);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",91)
		if (((dy > (int)0))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",93)
			hx::SubEq(this->y,dy);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",94)
			hx::AddEq(this->height,dy);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",96)
		if (((r->nmeGetRight() > this->nmeGetRight()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",97)
			this->nmeSetRight(r->nmeGetRight());
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",98)
		if (((r->nmeGetBottom() > this->nmeGetBottom()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",99)
...
Void Rectangle_obj::inflate( double dx,double dy){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",105)
		hx::SubEq(this->x,dx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",105)
		hx::AddEq(this->width,(dx * (int)2));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",106)
		hx::SubEq(this->y,dy);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",106)
...
Void Rectangle_obj::inflatePoint( ::neash::geom::Point point){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",111)
...
::neash::geom::Rectangle Rectangle_obj::intersection( ::neash::geom::Rectangle toIntersect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",118)
	double x0 = (  (((this->x < toIntersect->x))) ? double(toIntersect->x) : double(this->x) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",119)
	double x1 = (  (((this->nmeGetRight() > toIntersect->nmeGetRight()))) ? double(toIntersect->nmeGetRight()) : double(this->nmeGetRight()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",120)
	if (((x1 <= x0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",121)
		return ::neash::geom::Rectangle_obj::__new(null(),null(),null(),null());
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",123)
	double y0 = (  (((this->y < toIntersect->y))) ? double(toIntersect->y) : double(this->y) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",124)
	double y1 = (  (((this->nmeGetBottom() > toIntersect->nmeGetBottom()))) ? double(toIntersect->nmeGetBottom()) : double(this->nmeGetBottom()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",125)
	if (((y1 <= y0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",126)
		return ::neash::geom::Rectangle_obj::__new(null(),null(),null(),null());
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",128)
...
bool Rectangle_obj::intersects( ::neash::geom::Rectangle toIntersect){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",134)
	double x0 = (  (((this->x < toIntersect->x))) ? double(toIntersect->x) : double(this->x) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",135)
	double x1 = (  (((this->nmeGetRight() > toIntersect->nmeGetRight()))) ? double(toIntersect->nmeGetRight()) : double(this->nmeGetRight()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",136)
	if (((x1 <= x0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",137)
		return false;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",139)
	double y0 = (  (((this->y < toIntersect->y))) ? double(toIntersect->y) : double(this->y) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",140)
	double y1 = (  (((this->nmeGetBottom() > toIntersect->nmeGetBottom()))) ? double(toIntersect->nmeGetBottom()) : double(this->nmeGetBottom()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",141)
	return (y1 > y0);
}
...
bool Rectangle_obj::isEmpty( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",146)
...
Void Rectangle_obj::offset( double dx,double dy){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",153)
		hx::AddEq(this->x,dx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",154)
		hx::AddEq(this->y,dy);
	}
return null();
}
...
Void Rectangle_obj::offsetPoint( ::neash::geom::Point point){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",160)
		hx::AddEq(this->x,point->x);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",161)
...
Void Rectangle_obj::setEmpty( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",166)
...
::neash::geom::Rectangle Rectangle_obj::transform( ::neash::geom::Matrix m){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",173)
	double tx0 = ((m->a * this->x) + (m->c * this->y));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",174)
	double tx1 = tx0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",175)
	double ty0 = ((m->b * this->x) + (m->d * this->y));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",176)
	double ty1 = tx0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",178)
	double tx = ((m->a * ((this->x + this->width))) + (m->c * this->y));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",179)
	double ty = ((m->b * ((this->x + this->width))) + (m->d * this->y));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",180)
	if (((tx < tx0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",180)
		tx0 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",181)
	if (((ty < ty0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",181)
		ty0 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",182)
	if (((tx > tx1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",182)
		tx1 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",183)
	if (((ty > ty1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",183)
		ty1 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",185)
	tx = ((m->a * ((this->x + this->width))) + (m->c * ((this->y + this->height))));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",186)
	ty = ((m->b * ((this->x + this->width))) + (m->d * ((this->y + this->height))));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",187)
	if (((tx < tx0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",187)
		tx0 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",188)
	if (((ty < ty0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",188)
		ty0 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",189)
	if (((tx > tx1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",189)
		tx1 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",190)
	if (((ty > ty1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",190)
		ty1 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",192)
	tx = ((m->a * this->x) + (m->c * ((this->y + this->height))));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",193)
	ty = ((m->b * this->x) + (m->d * ((this->y + this->height))));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",194)
	if (((tx < tx0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",194)
		tx0 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",195)
	if (((ty < ty0))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",195)
		ty0 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",196)
	if (((tx > tx1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",196)
		tx1 = tx;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",197)
	if (((ty > ty1))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",197)
		ty1 = ty;
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",199)
...
::neash::geom::Rectangle Rectangle_obj::_union( ::neash::geom::Rectangle toUnion){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",205)
	double x0 = (  (((this->x > toUnion->x))) ? double(toUnion->x) : double(this->x) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",206)
	double x1 = (  (((this->nmeGetRight() < toUnion->nmeGetRight()))) ? double(toUnion->nmeGetRight()) : double(this->nmeGetRight()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",207)
	double y0 = (  (((this->y > toUnion->y))) ? double(toUnion->y) : double(this->y) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",208)
	double y1 = (  (((this->nmeGetBottom() < toUnion->nmeGetBottom()))) ? double(toUnion->nmeGetBottom()) : double(this->nmeGetBottom()) );
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",209)
	return ::neash::geom::Rectangle_obj::__new(x0,y0,(x1 - x0),(y1 - y0));
}
...
double Rectangle_obj::nmeGetBottom( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",218)
...
double Rectangle_obj::nmeSetBottom( double b){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",219)
...
::neash::geom::Point Rectangle_obj::nmeGetBottomRight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",220)
...
::neash::geom::Point Rectangle_obj::nmeSetBottomRight( ::neash::geom::Point p){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",221)
...
double Rectangle_obj::nmeGetLeft( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",222)
	return this->x;
}
...
double Rectangle_obj::nmeSetLeft( double l){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",223)
...
double Rectangle_obj::nmeGetRight( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",224)
...
double Rectangle_obj::nmeSetRight( double r){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",225)
	this->width = (r - this->x);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",225)
	return r;
}
...
::neash::geom::Point Rectangle_obj::nmeGetSize( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",226)
...
::neash::geom::Point Rectangle_obj::nmeSetSize( ::neash::geom::Point p){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",227)
	this->width = p->x;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",227)
	this->height = p->y;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",227)
...
double Rectangle_obj::nmeGetTop( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",228)
	return this->y;
}
...
double Rectangle_obj::nmeSetTop( double t){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",229)
...
::neash::geom::Point Rectangle_obj::nmeGetTopLeft( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",230)
...
::neash::geom::Point Rectangle_obj::nmeSetTopLeft( ::neash::geom::Point p){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",231)
	this->x = p->x;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",231)
	this->y = p->y;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Rectangle.hx",231)
