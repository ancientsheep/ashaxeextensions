...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Transform.hx",20)
...
::neash::geom::ColorTransform Transform_obj::nmeGetColorTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Transform.hx",30)
...
::neash::geom::ColorTransform Transform_obj::nmeSetColorTransform( ::neash::geom::ColorTransform inTrans){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Transform.hx",31)
...
::neash::geom::ColorTransform Transform_obj::nmeGetConcatenatedColorTransform( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Transform.hx",32)
...
::neash::geom::Matrix Transform_obj::nmeGetConcatenatedMatrix( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Transform.hx",33)
...
::neash::geom::Matrix Transform_obj::nmeGetMatrix( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Transform.hx",34)
...
::neash::geom::Matrix Transform_obj::nmeSetMatrix( ::neash::geom::Matrix inMatrix){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Transform.hx",35)
...
::neash::geom::Rectangle Transform_obj::nmeGetPixelBounds( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Transform.hx",36)
