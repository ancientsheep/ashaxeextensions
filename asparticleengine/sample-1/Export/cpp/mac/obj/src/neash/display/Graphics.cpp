...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",28)
...
Void Graphics_obj::arcTo( double inCX,double inCY,double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",34)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",40)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",46)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",53)
		if (((matrix == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",55)
			matrix = ::neash::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",56)
			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",59)
...
Void Graphics_obj::clear( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",64)
...
Void Graphics_obj::curveTo( double inCX,double inCY,double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",70)
...
Void Graphics_obj::drawCircle( double inX,double inY,double inRadius){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",76)
...
Void Graphics_obj::drawEllipse( double inX,double inY,double inWidth,double inHeight){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",82)
...
Void Graphics_obj::drawGraphicsData( Array< ::neash::display::IGraphicsData > graphicsData){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",89)
		Dynamic handles = Dynamic( Array_obj<Dynamic>::__new() );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",91)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",91)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",91)
			while(((_g < graphicsData->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",91)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",92)
				handles->__Field(HX_CSTRING("push"),true)(datum->nmeHandle);
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",94)
...
Void Graphics_obj::drawGraphicsDatum( ::neash::display::IGraphicsData graphicsDatum){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",99)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",105)
...
Void Graphics_obj::drawRect( double inX,double inY,double inWidth,double inHeight){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",111)
...
Void Graphics_obj::drawRoundRect( double inX,double inY,double inWidth,double inHeight,double inRadX,Dynamic inRadY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",117)
...
Void Graphics_obj::drawPath( Array< int > commands,Array< double > data,hx::Null< ::String >  __o_winding){
::String winding = __o_winding.Default(HX_CSTRING("evenOdd"));
	HX_SOURCE_PUSH("Graphics_obj::drawPath");
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",122)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",132)
		this->beginBitmapFill(sheet->nmeBitmap,null(),false,inSmooth);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",134)
		if ((inSmooth)){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",135)
			hx::OrEq(inFlags,(int)4096);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",137)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",143)
		int cull = (  (((culling == null()))) ? int((int)0) : int((culling->__Index() - (int)1)) );
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",144)
...
Void Graphics_obj::endFill( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",149)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",155)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",162)
		if (((matrix == null()))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",164)
			matrix = ::neash::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",165)
			matrix->createGradientBox((int)200,(int)200,(int)0,(int)-100,(int)-100);
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",168)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",173)
...
Void Graphics_obj::lineTo( double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",179)
...
Void Graphics_obj::moveTo( double inX,double inY){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",185)
...
{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/display/Graphics.hx",191)
...
void Graphics_obj::__boot()
{
	...
	hx::Static(TILE_TRANS_2x2) = (int)16;
	...
	hx::Static(nme_gfx_draw_path) = ::neash::Loader_obj::load(HX_CSTRING("nme_gfx_draw_path"),(int)4);
