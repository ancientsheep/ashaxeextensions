...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",40)
	this->x = inX;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",41)
	this->y = inY;
}
;
	return null();
...
::neash::geom::Point Point_obj::add( ::neash::geom::Point v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",46)
...
::neash::geom::Point Point_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",52)
...
bool Point_obj::equals( ::neash::geom::Point toCompare){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",66)
...
Void Point_obj::normalize( double thickness){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",78)
		if (((bool((this->x == (int)0)) && bool((this->y == (int)0))))){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",80)
			return null();
		}
		else{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",85)
			double norm = (double(thickness) / double(::Math_obj::sqrt(((this->x * this->x) + (this->y * this->y)))));
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",86)
			hx::MultEq(this->x,norm);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",87)
...
Void Point_obj::offset( double dx,double dy){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",94)
		hx::AddEq(this->x,dx);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",95)
		hx::AddEq(this->y,dy);
	}
return null();
}
...
::neash::geom::Point Point_obj::subtract( ::neash::geom::Point v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",106)
...
double Point_obj::nmeGetLength( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",117)
...
double Point_obj::distance( ::neash::geom::Point pt1,::neash::geom::Point pt2){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",59)
	double dx = (pt1->x - pt2->x);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",60)
	double dy = (pt1->y - pt2->y);
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",61)
...
::neash::geom::Point Point_obj::interpolate( ::neash::geom::Point pt1,::neash::geom::Point pt2,double f){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",72)
...
::neash::geom::Point Point_obj::polar( double len,double angle){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/Point.hx",100)
