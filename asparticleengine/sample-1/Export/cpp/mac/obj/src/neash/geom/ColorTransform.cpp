...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",25)
	this->redMultiplier = inRedMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",26)
	this->greenMultiplier = inGreenMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",27)
	this->blueMultiplier = inBlueMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",28)
	this->alphaMultiplier = inAlphaMultiplier;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",29)
	this->redOffset = inRedOffset;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",30)
	this->greenOffset = inGreenOffset;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",31)
	this->blueOffset = inBlueOffset;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",32)
...
Void ColorTransform_obj::concat( ::neash::geom::ColorTransform second){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",38)
		hx::AddEq(this->redMultiplier,second->redMultiplier);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",39)
		hx::AddEq(this->greenMultiplier,second->greenMultiplier);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",40)
		hx::AddEq(this->blueMultiplier,second->blueMultiplier);
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",41)
...
int ColorTransform_obj::nmeGetColor( ){
	HX_SOURCE_PUSH("ColorTransform_obj::nmeGetColor")
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",49)
...
HX_DEFINE_DYNAMIC_FUNC0(ColorTransform_obj,nmeGetColor,return )

int ColorTransform_obj::nmeSetColor( int value){
	HX_SOURCE_PUSH("ColorTransform_obj::nmeSetColor")
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",56)
	this->redOffset = (int((int(value) >> int((int)16))) & int((int)255));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",57)
	this->greenOffset = (int((int(value) >> int((int)8))) & int((int)255));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",58)
	this->blueOffset = (int(value) & int((int)255));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",60)
	this->redMultiplier = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",61)
	this->greenMultiplier = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",62)
	this->blueMultiplier = (int)0;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/geom/ColorTransform.hx",64)
	return this->nmeGetColor();
}


HX_DEFINE_DYNAMIC_FUNC1(ColorTransform_obj,nmeSetColor,return )
...
Dynamic ColorTransform_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 5:
		if (HX_FIELD_EQ(inName,"color") ) { return inCallProp ? nmeGetColor() : color; }
		break;
	case 6:
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"nmeGetColor") ) { return nmeGetColor_dyn(); }
		if (HX_FIELD_EQ(inName,"nmeSetColor") ) { return nmeSetColor_dyn(); }
		break;
	case 13:
...
Dynamic ColorTransform_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"color") ) { if (inCallProp) return nmeSetColor(inValue);color=inValue.Cast< int >(); return inValue; }
		break;
	case 9:
...
static ::String sMemberFields[] = {
	...
	HX_CSTRING("concat"),
	HX_CSTRING("nmeGetColor"),
	HX_CSTRING("nmeSetColor"),
	String(null()) };
