...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/filters/BitmapFilter.hx",11)
	this->type = inType;
}
;
	return null();
...
::neash::filters::BitmapFilter BitmapFilter_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/filters/BitmapFilter.hx",18)
	hx::Throw (HX_CSTRING("clone not implemented"));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/filters/BitmapFilter.hx",19)
	return null();
}
