...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",7)
	if (((inEncoded != null()))){
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",9)
...
Void URLVariables_obj::decode( ::String inVars){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",14)
		Array< ::String > fields = ::Reflect_obj::fields(hx::ObjectPtr<OBJ_>(this));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",15)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",15)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",15)
			while(((_g < fields->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",15)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",16)
				::Reflect_obj::deleteField(hx::ObjectPtr<OBJ_>(this),f);
			}
		}
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",17)
		Array< ::String > fields1 = inVars.split(HX_CSTRING(";"))->join(HX_CSTRING("&")).split(HX_CSTRING("&"));
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",18)
		{
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",18)
			int _g = (int)0;
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",18)
			while(((_g < fields1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",18)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",20)
				int eq = f.indexOf(HX_CSTRING("="),null());
				HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",21)
				if (((eq > (int)0))){
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",22)
					this->__SetField(::StringTools_obj::urlDecode(f.substr((int)0,eq)),::StringTools_obj::urlDecode(f.substr((eq + (int)1),null())),false);
				}
				else{
					HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",24)
					if (((eq != (int)0))){
						HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",25)
...
::String URLVariables_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",31)
	Array< ::String > result = Array_obj< ::String >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",32)
	Array< ::String > fields = ::Reflect_obj::fields(hx::ObjectPtr<OBJ_>(this));
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",33)
	{
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",33)
		int _g = (int)0;
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",33)
		while(((_g < fields->length))){
			...
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",33)
			++(_g);
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",34)
			result->push(((::StringTools_obj::urlEncode(f) + HX_CSTRING("=")) + ::StringTools_obj::urlEncode(::Reflect_obj::field(hx::ObjectPtr<OBJ_>(this),f))));
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/net/URLVariables.hx",36)
