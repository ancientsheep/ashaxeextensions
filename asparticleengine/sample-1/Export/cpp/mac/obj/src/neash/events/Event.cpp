...
{
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",52)
	this->_type = type;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",53)
	this->_bubbles = bubbles;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",54)
	this->_cancelable = cancelable;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",55)
	this->nmeIsCancelled = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",56)
	this->nmeIsCancelledNow = false;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",57)
	this->_target = null();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",58)
	this->_currentTarget = null();
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",59)
...
::neash::events::Event Event_obj::clone( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",64)
...
bool Event_obj::nmeGetIsCancelled( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",70)
...
bool Event_obj::nmeGetIsCancelledNow( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",76)
...
Void Event_obj::nmeSetPhase( int inPhase){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",82)
...
Void Event_obj::stopImmediatePropagation( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",89)
		if ((this->nmeGetCancelable())){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",91)
...
Void Event_obj::stopPropagation( ){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",96)
		if ((this->nmeGetCancelable())){
			HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",98)
...
::String Event_obj::toString( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",103)
...
bool Event_obj::nmeGetBubbles( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",113)
...
bool Event_obj::nmeGetCancelable( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",114)
...
Dynamic Event_obj::nmeGetCurrentTarget( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",115)
...
Dynamic Event_obj::nmeSetCurrentTarget( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",116)
...
int Event_obj::nmeGetEventPhase( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",117)
...
Dynamic Event_obj::nmeGetTarget( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",118)
	return this->_target;
}
...
Dynamic Event_obj::nmeSetTarget( Dynamic v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",119)
	this->_target = v;
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",119)
	return v;
}
...
::String Event_obj::nmeGetType( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/lib/nme/3,4,3/neash/events/Event.hx",120)
	return this->_type;
}
