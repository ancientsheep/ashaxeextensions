...
void Xml_obj::__init__(){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",421)
...
::String Xml_obj::getNodeName( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",175)
...
::String Xml_obj::setNodeName( ::String n){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",181)
...
::String Xml_obj::getNodeValue( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",187)
...
::String Xml_obj::setNodeValue( ::String v){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",193)
...
::Xml Xml_obj::getParent( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",197)
	return this->_parent;
}
...
::String Xml_obj::get( ::String att){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",204)
...
Void Xml_obj::set( ::String att,::String value){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",213)
		return null();
	}
return null();
}
...
Void Xml_obj::remove( ::String att){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",220)
		return null();
	}
return null();
}
...
bool Xml_obj::exists( ::String att){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",226)
...
Dynamic Xml_obj::attributes( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",232)
...
Dynamic Xml_obj::iterator( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",238)
...
Dynamic Xml_obj::elements( ){
	...
	Array< Array< ::Xml > > children = Array_obj< Array< ::Xml > >::__new().Add(this->_children);
				...
				bool run(){
{
						...
						int k = __this->__Field(HX_CSTRING("cur"),true);
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",250)
						int l = children->__get((int)0)->length;
						...
						while(((k < l))){
							...
							HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",254)
							hx::AddEq(k,(int)1);
						}
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",256)
						__this->__FieldRef(HX_CSTRING("cur")) = k;
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",257)
						return (k < l);
					}
					return null();
				}
				...
				::Xml run(){
{
						...
						while(((k < l))){
							...
							::Xml n = children->__get((int)0)->__get(k);
							...
							if (((n->nodeType == ::Xml_obj::Element))){
								...
								__this->__FieldRef(HX_CSTRING("cur")) = k;
								HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",267)
								return n;
							}
						}
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",270)
						return null();
					}
					return null();
				}
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",246)
				...
				bool run(){
{
						...
						while(((k < l))){
							...
							HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",288)
							(k)++;
						}
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",290)
						__this->__FieldRef(HX_CSTRING("cur")) = k;
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",291)
						return (k < l);
					}
					return null();
				}
				...
				::Xml run(){
{
						...
						while(((k < l))){
							...
							if (((bool((n->nodeType == ::Xml_obj::Element)) && bool((n->_nodeName == name1->__get((int)0)))))){
								...
								__this->__FieldRef(HX_CSTRING("cur")) = k;
								HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",301)
								return n;
							}
						}
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",304)
						return null();
					}
					return null();
				}
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",279)
...
::Xml Xml_obj::firstChild( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",312)
...
::Xml Xml_obj::firstElement( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",318)
	{
		...
		while(((_g1 < _g))){
			...
			::Xml n = this->_children->__get(cur);
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",320)
			if (((n->nodeType == ::Xml_obj::Element))){
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",321)
				return n;
			}
		}
	}
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",323)
	return null();
}
...
Void Xml_obj::addChild( ::Xml x){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",332)
		return null();
	}
return null();
}
...
bool Xml_obj::removeChild( ::Xml x){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",340)
	return b;
}
...
Void Xml_obj::insertChild( ::Xml x,int pos){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",349)
		return null();
	}
return null();
}
...
::String Xml_obj::toString( ){
	...
	this->toStringRec(s);
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",355)
...
Void Xml_obj::toStringRec( ::StringBuf s){
{
		...
		if (  ( _switch_1==::Xml_obj::Document)){
			...
			while(((_g < _g1->length))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",361)
				++(_g);
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",362)
				x->toStringRec(s);
			}
		}
			...
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",366)
			{
				...
				while(((_g < _g1->length))){
					...
					HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",372)
					hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"),true)) = ::String::fromCharCode((int)34);
				}
			}
			...
			if (((this->_children->length == (int)0))){
				...
				HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",377)
				return null();
			}
			...
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",386)
			...
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"),true)) = this->_nodeValue;
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",391)
			...
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"),true)) = this->_nodeValue;
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",395)
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"),true)) = HX_CSTRING("-->");
		}
			...
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"),true)) = this->_nodeValue;
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",399)
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"),true)) = HX_CSTRING(">");
		}
			...
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"),true)) = this->_nodeValue;
			HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",403)
			hx::IndexRef((s->b).mPtr,s->b->__Field(HX_CSTRING("length"),true)) = HX_CSTRING("?>");
		}
	}
return null();
				...
				Void run(::String text){
{
						...
						::Xml p = __this->__Field(HX_CSTRING("cur"),true);
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",102)
						p->addChild(x1);
					}
					return null();
				}
				...
				Void run(){
{
						HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",104)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",110)
	return x;
}
...
::Xml Xml_obj::createElement( ::String name){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",120)
	return r;
}
...
::Xml Xml_obj::createPCData( ::String data){
	...
	r->_nodeValue = data;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",127)
	return r;
}
...
::Xml Xml_obj::createCData( ::String data){
	...
	r->_nodeValue = data;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",134)
	return r;
}
...
::Xml Xml_obj::createComment( ::String data){
	...
	r->_nodeValue = data;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",141)
	return r;
}
...
::Xml Xml_obj::createDocType( ::String data){
	...
	r->_nodeValue = data;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",148)
	return r;
}
...
::Xml Xml_obj::createProlog( ::String data){
	...
	r->_nodeValue = data;
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",155)
	return r;
}
...
::Xml Xml_obj::createDocument( ){
	...
	r->_children = Array_obj< ::Xml >::__new();
	HX_SOURCE_POS("/usr/lib/haxe/std/cpp/_std/Xml.hx",162)
	return r;
}
