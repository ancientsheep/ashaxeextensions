...
class Lib_obj : public hx::Object{
	...
	public:
		...
		static Void create( Dynamic onLoaded,int width,int height,hx::Null< double >  frameRate,hx::Null< int >  color,hx::Null< int >  flags,hx::Null< ::String >  title,::neash::display::BitmapData icon);
