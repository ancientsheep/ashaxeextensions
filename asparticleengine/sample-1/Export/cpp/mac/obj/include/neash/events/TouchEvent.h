...
class TouchEvent_obj : public ::neash::events::MouseEvent_obj{
	...
	public:
		...
		static ::neash::events::TouchEvent nmeCreate( ::String inType,Dynamic inEvent,::neash::geom::Point inLocal,::neash::display::InteractiveObject inTarget,double sizeX,double sizeY);
