...
class NXEvent extends Event{
	...
	public inline static var IN_APP_PURCHASE_RESTORE_SUCCESS:String = "inAppPurchaseRestoreSuccess"; // 16
	public inline static var IN_APP_PURCHASE_RESTORE_FAIL:String = "inAppPurchaseRestoreFail"; // 17
